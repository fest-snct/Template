...
// OGP settings
$ogp_title = 'コスプレ大会 | ' . $site_config['festival_label'];
$ogp_description = $site_config['festival_label'] . 'でコスプレ大会を開催します!奮ってご参加ください。';
$ogp_type = 'article';
$ogp_image = (empty($_SERVER['HTTPS']) ? 'http://' : 'https://') . $_SERVER['HTTP_HOST'] . $site_config['base_path'] . 'images/event/kosupure.webp';
